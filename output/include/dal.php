...
class tDAL
{
	var $tbltodo_at_localhost__activities;
	var $tbltodo_at_localhost__users;
	var $lstTables;
	var $Table = array();
	...
	function FillTablesList()
	{
		if($this->lstTables)
			return;
		$this->lstTables[] = array("name" => "activities", "varname" => "todo_at_localhost__activities", "altvarname" => "activities", "connId" => "todo_at_localhost", "schema" => "", "connName" => "todo at localhost");
		$this->lstTables[] = array("name" => "users", "varname" => "todo_at_localhost__users", "altvarname" => "users", "connId" => "todo_at_localhost", "schema" => "", "connName" => "todo at localhost");
	}
