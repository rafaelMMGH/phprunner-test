...
class DB
{
	...
	protected static function _fillTablesList( $conn )
	{
		...
		if( "todo_at_localhost" == $conn->connId )
		{
			$dalTables[$conn->connId][] = array("name" => "activities", "varname" => "todo_at_localhost__activities", "altvarname" => "activities", "connId" => "todo_at_localhost", "schema" => "", "connName" => "todo at localhost");
			$dalTables[$conn->connId][] = array("name" => "users", "varname" => "todo_at_localhost__users", "altvarname" => "users", "connId" => "todo_at_localhost", "schema" => "", "connName" => "todo at localhost");
		}
	}
