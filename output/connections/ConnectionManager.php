...
class ConnectionManager extends ConnectionManager_Base
{
	...
	protected function _setConnectionsData()
	{
		...
		$data = array();
		$data["dbType"] = 0;
		$data["connId"] = "todo_at_localhost";
		$data["connName"] = "todo at localhost";
		$data["connStringType"] = "mysql";
		$data["connectionString"] = "mysql;localhost;root;root;;todo;;1"; //currently unused

		$this->_connectionsIdByName["todo at localhost"] = "todo_at_localhost";
		...
		$data["connInfo"][3] = "";
		$data["connInfo"][4] = "todo";
		$data["connInfo"][5] = ""; //currently unused
		$data["connInfo"][6] = "1"; //currently unused
		$data["ODBCString"] = "DRIVER={MySQL ODBC 3.51 Driver};Server=localhost;Uid=root;Pwd=root;Database=todo;OPTION=3";
		// encription set
		...
		$connectionsData["todo_at_localhost"] = $data;
